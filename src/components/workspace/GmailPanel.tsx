            ...
            <div className="p-4">
              ...
              <div className="mt-6 pt-4 border-t border-zinc-100 flex gap-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 text-xs font-semibold text-zinc-600 border border-zinc-200 hover:bg-zinc-50 hover:border-zinc-300 py-2 rounded-xl transition-all"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="px-3 flex items-center justify-center text-zinc-400 border border-zinc-200 hover:bg-zinc-50 hover:text-zinc-600 rounded-xl transition-all"
                  title="Open in Gmail"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
