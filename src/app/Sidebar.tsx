    ...
    >
      ...
      <nav className={`flex-1 flex flex-col pt-4 pb-4 overflow-y-auto ${isCollapsed ? "px-2" : "px-3"}`}>
        ...
        <div className="space-y-0.5 mb-4">
          ...
          <a href="/api/auth/logout" className={`flex items-center gap-3 p-2 rounded-lg text-sm font-medium cursor-pointer transition-colors hover:bg-red-50 hover:text-red-600 text-zinc-500 ${isCollapsed ? "justify-center" : ""}`} title={isCollapsed ? "Sign Out" : ""}>
